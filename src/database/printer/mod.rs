...
{
    let result: (Counter, QueueCtl, EnergyCtl, String, String) =
        counter::table.inner_join(model::table.inner_join(printer::table).inner_join(energy_ctl::table).inner_join(queue_ctl::table))
